window.onload = function() {
    ...
    function start(){
    println("You need to take 20 balls to win the game .");
    println("At first it might seem easy, but don't distract") ;
    println("Rule: if you cross canvas you lose!");
    drawSnake();
    setTimer(draw,30);
    keyDownMethod(key);
    ...
    snake.getX()-snakeRadius<0 ||
    snake.getY()+snakeRadius>getHeight() ||
    snake.getY()-snakeRadius<0
    ){
    stopTimer(draw);
